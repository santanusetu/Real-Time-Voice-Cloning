# Tried this version and it's working with my Macbook pro setup. Generated results have been positive so far, but needs improvement.

To-do: Make a YT video of the set up and process. Might be good for others.
